...
const styles = StyleSheet.create({
  ...
  noiseOptionActive: { backgroundColor: nsnColors.selectedChip, borderColor: nsnColors.selectedChipBorder },
  noiseOptionText: { color: nsnColors.muted, fontSize: 12, fontWeight: "900", marginBottom: 0 },
  noiseOptionTextActive: { color: nsnColors.selectedChipText },
  mapPanel: {
    minHeight: 174,
    borderRadius: 18,
    borderWidth: 1,
  ...
  placeOptionActive: { borderColor: nsnColors.selectedChipBorder },
  placeCopy: { flex: 1 },
