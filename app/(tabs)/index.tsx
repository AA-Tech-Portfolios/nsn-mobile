...
function EventTag({ icon, label, isDay, isRtl }: { icon: "pace" | "volume" | "volume.off" | "weather" | "visibility"; label: string; isDay?: boolean; isRtl?: boolean }) {
  return (
