...
const tabLabels: Record<
  string,
  { home: string; meetups: string; chats: string; alerts: string; profile: string }
> = {
  English: {
    home: "Home",
    meetups: "Meetups",
...
export default function TabLayout() {
  ...
  const renderTabIcon = (name: IconSymbolName, label: string) => {
    ...
    TabIconRenderer.displayName = `TabIconRenderer(${label})`;
    ...
    >
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarAccessibilityLabel: screenReaderHints
            ? `${labels.home}. Opens your home feed and event suggestions.`
            : labels.home,
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarAccessibilityLabel: screenReaderHints
            ? `${labels.meetups}. Opens your joined and upcoming meetups.`
            : labels.meetups,
      ...
      <Tabs.Screen
        ...
        options={{
          title: labels.chats,
          tabBarAccessibilityLabel: screenReaderHints
            ? `${labels.chats}. Opens meetup group chats and private chats.`
            : labels.chats,
      ...
      <Tabs.Screen
        ...
        options={{
          title: labels.alerts,
          tabBarAccessibilityLabel: screenReaderHints
            ? `${labels.alerts}. Opens reminders and safety alerts.`
            : labels.alerts,
