...
const styles = StyleSheet.create({
  ...
  daySettingsShortcut: { backgroundColor: "#FFFFFF", borderColor: "#D8E1EA" },
  ...
  dayWeatherFlow: { backgroundColor: "#FFFFFF", borderColor: "#D8E1EA" },
  ...
  dayIconBubble: { backgroundColor: "#F4F7FB" },
