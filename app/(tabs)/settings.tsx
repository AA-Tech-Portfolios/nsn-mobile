...
const settingsTranslations: Record<string, SettingsCopy> = {
  ...
  Arabic: {
    ...
    restartOnboarding: "إعادة بدء إعداد NSN",
  ...
  Hebrew: {
    ...
    restartOnboarding: "התחלת ההיכרות עם NSN מחדש",
  ...
  Hindi: {
    ...
    restartOnboarding: "NSN परिचय फिर शुरू करें",
  ...
  Korean: {
    ...
    restartOnboarding: "NSN 온보딩 다시 시작",
  ...
  Persian: {
    ...
    restartOnboarding: "شروع دوباره آشنایی با NSN",
  ...
  Spanish: {
    ...
    restartOnboarding: "Reiniciar bienvenida de NSN",
  ...
  Urdu: {
    ...
    restartOnboarding: "NSN تعارف دوبارہ شروع کریں",
  ...
  Bengali: {
    ...
    restartOnboarding: "NSN পরিচিতি আবার শুরু করুন",
  ...
  Indonesian: {
    ...
    restartOnboarding: "Mulai ulang perkenalan NSN",
  ...
  Malay: {
    ...
    restartOnboarding: "Mulakan semula pengenalan NSN",
  ...
  Russian: {
    ...
    restartOnboarding: "Перезапустить знакомство с NSN",
  ...
  Thai: {
    ...
    restartOnboarding: "เริ่มแนะนำ NSN ใหม่",
  ...
  Vietnamese: {
    ...
    restartOnboarding: "Bắt đầu lại phần giới thiệu NSN",
...
const supplementalSettingsTranslations: Record<string, Partial<SettingsCopy>> = {
  Afrikaans: {
    ...
    restartOnboarding: "Begin NSN-kennismaking weer",
  ...
  Albanian: {
    ...
    restartOnboarding: "Rifillo prezantimin e NSN",
  ...
  Armenian: {
    ...
    restartOnboarding: "Կրկին սկսել NSN ծանոթացումը",
  ...
  Croatian: {
    ...
    restartOnboarding: "Ponovno pokreni NSN uvod",
  ...
  Czech: {
    ...
    restartOnboarding: "Spustit úvod NSN znovu",
  ...
  Estonian: {
    ...
    restartOnboarding: "Alusta NSN tutvustust uuesti",
  ...
  Hungarian: {
    ...
    restartOnboarding: "NSN bevezető újraindítása",
  ...
  Latvian: {
    ...
    restartOnboarding: "Sākt NSN ievadu no jauna",
  ...
  Lithuanian: {
    ...
    restartOnboarding: "Pradėti NSN įvadą iš naujo",
  ...
  Luxembourgish: {
    ...
    restartOnboarding: "NSN-Aféierung nei starten",
    restartOnboardingAction: "Start",
  ...
  Slovak: {
    ...
    restartOnboarding: "Spustiť úvod NSN znova",
...
const settingsSectionTranslations: Record<string, Partial<SettingsCopy>> = {
  ...
  Filipino: {
    ...
    colorPaletteCopy: "Piliin ang mood at accent colours na mas komportable sa iyo.",
