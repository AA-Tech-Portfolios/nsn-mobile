...
export const profilePreferenceTranslations: Record<string, ProfilePreferenceCopy> = {
  ...
  Chinese: {
    ...
    transportation: {
      title: "交通方式",
      copy: "选择你通常如何到达，让集合点和时间安排更轻松。",
      options: {
        Driving: { label: "开车", copy: "我可能需要停车信息或清晰的集合点。" },
        "Public transport": { label: "公共交通", copy: "我会乘火车、公交、地铁、轻轨或渡轮到达。" },
        Walking: { label: "步行", copy: "我就在附近，会步行到达。" },
        Cycling: { label: "骑车", copy: "我可能需要合适的锁车地点。" },
        Rideshare: { label: "网约车", copy: "我可能需要方便上下车的位置。" },
        "Getting dropped off": { label: "有人送我", copy: "会有人帮我到达那里。" },
        "Not sure yet": { label: "还不确定", copy: "我会在接近聚会时再决定。" },
      },
    },
    food: {
      title: "饮食与付款偏好",
      copy: "在用餐聚会前分享饮食需求和付款期待，避免现场猜测。",
      dietary: "饮食偏好或限制",
      payment: "餐费付款偏好",
      dietaryOptions: {
        "No preference": "无偏好",
        ...
        "Prefer non-alcohol venues": "偏好无酒精场所",
      },
    },
    hobbies: {
      title: "爱好与兴趣",
      copy: "选择你平时喜欢做的事，让聚会更贴近真实生活。",
      personalTime: "个人时间",
  ...
  Japanese: {
    ...
    transportation: {
      title: "移動手段",
      copy: "普段どのように到着するかを選ぶと、集合場所と時間が決めやすくなります。",
      options: {
        Driving: { label: "車", copy: "駐車場や分かりやすい集合場所が必要かもしれません。" },
        "Public transport": { label: "公共交通機関", copy: "電車、バス、メトロ、ライトレール、フェリーで向かいます。" },
        Walking: { label: "徒歩", copy: "近くにいて、歩いて向かいます。" },
        Cycling: { label: "自転車", copy: "自転車を安全に停める場所が必要かもしれません。" },
        Rideshare: { label: "ライドシェア", copy: "乗降しやすい場所が必要かもしれません。" },
        "Getting dropped off": { label: "送ってもらう", copy: "誰かに送ってもらいます。" },
        "Not sure yet": { label: "まだ未定", copy: "ミートアップが近づいたら決めます。" },
      },
    },
    food: {
      title: "食事と支払いの希望",
      copy: "食事系ミートアップの前に、食事の希望や支払いの考え方を共有できます。",
      dietary: "食事・食生活の希望",
      payment: "食事代の支払い希望",
      dietaryOptions: {
        "No preference": "希望なし",
        ...
        "Prefer non-alcohol venues": "ノンアルコールの場所を希望",
      },
    },
    hobbies: {
      title: "趣味と興味",
      copy: "自分の時間に好きなことを選びましょう。",
      personalTime: "自分の時間",
  ...
  Korean: {
    ...
    transportation: {
      title: "이동 방법",
      copy: "보통 어떻게 도착하는지 선택하면 만나는 장소와 시간이 더 쉬워져요.",
      options: {
        Driving: { label: "운전", copy: "주차 정보나 명확한 만나는 지점이 필요할 수 있어요." },
        "Public transport": { label: "대중교통", copy: "기차, 버스, 메트로, 경전철 또는 페리로 도착해요." },
        Walking: { label: "도보", copy: "근처에 있어서 걸어서 도착해요." },
        Cycling: { label: "자전거", copy: "자전거를 잠글 수 있는 적당한 곳이 필요할 수 있어요." },
        Rideshare: { label: "라이드셰어", copy: "승하차하기 편한 장소가 필요할 수 있어요." },
        "Getting dropped off": { label: "데려다 줌", copy: "다른 사람이 데려다줘요." },
        "Not sure yet": { label: "아직 미정", copy: "모임이 가까워지면 결정할게요." },
      },
    },
    food: {
      title: "음식 및 결제 선호",
      copy: "식사 모임 전에 식단 필요와 결제 기대를 공유하세요.",
      dietary: "음식 또는 식단 선호",
      payment: "식사 결제 선호",
      dietaryOptions: {
        "No preference": "선호 없음",
        ...
        "Seafood allergy": "해산물 알레르기",
        "Prefer non-alcohol venues": "무알코올 장소 선호",
      },
    },
    hobbies: {
      title: "취미와 관심사",
      copy: "개인 시간에 좋아하는 활동을 선택하세요.",
      personalTime: "개인 시간",
