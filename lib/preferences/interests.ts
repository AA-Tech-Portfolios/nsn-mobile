...
export const interestPreferenceOptions: InterestPreference[] = [
  ...
  { id: "movie-marathons", label: "Movie marathons", category: "moviesTv", aliases: ["film marathon", "watch marathon"], genres: mediaGenres, eventKeywords: ["movie marathon", "watch", "movie night"] },
  ...mediaGenreInterests,
  ...
  { id: "bookstore-browsing", label: "Bookstore browsing", category: "reading", aliases: ["bookshop browsing"], eventKeywords: ["bookstore", "bookshop", "browsing", "books"] },
  ...
  { id: "arcades", label: "Arcades", category: "games", aliases: ["arcade games"], eventKeywords: ["arcade", "games"] },
  { id: "arcade-outing", label: "Arcade outing", category: "games", aliases: ["arcade meetup"], eventKeywords: ["arcade", "outing", "games"] },
  ...
  { id: "creative-hobbies", label: "Creative hobbies", category: "artCreativity", aliases: ["making things", "creative activities"], eventKeywords: ["creative", "art", "craft"] },
  { id: "lego-building-sets", label: "LEGO/building sets", category: "artCreativity", aliases: ["lego", "building sets", "bricks"], eventKeywords: ["lego", "building sets", "craft"] },
  { id: "lego-building-hobby-meetup", label: "LEGO/building hobby meetup", category: "artCreativity", aliases: ["lego meetup", "building sets meetup", "bricks meetup"], eventKeywords: ["lego", "building sets", "building hobby", "craft"] },
  ...
  { id: "beach-walk", label: "Beach walk", category: "outdoorsLocal", aliases: ["beach walks"], eventKeywords: ["beach walk", "beach", "walking"] },
  { id: "picnics", label: "Picnics", category: "outdoorsLocal", eventKeywords: ["picnic", "park"] },
  { id: "picnic-gathering", label: "Picnic gathering", category: "outdoorsLocal", aliases: ["picnic meetup"], eventKeywords: ["picnic", "gathering", "park"] },
  ...
  { id: "night-market-visit", label: "Night market visit", category: "outdoorsLocal", aliases: ["night markets"], eventKeywords: ["night market", "market", "food"] },
  { id: "theme-parks", label: "Theme parks", category: "outdoorsLocal", aliases: ["amusement parks"], eventKeywords: ["theme park", "rides"] },
  { id: "theme-park-outing", label: "Theme park outing", category: "outdoorsLocal", aliases: ["theme park meetup"], eventKeywords: ["theme park", "rides", "outing"] },
  { id: "water-parks", label: "Water parks", category: "outdoorsLocal", aliases: ["waterpark"], eventKeywords: ["water park", "swimming"] },
  { id: "water-park-outing", label: "Water park outing", category: "outdoorsLocal", aliases: ["waterpark outing"], eventKeywords: ["water park", "swimming", "outing"] },
  ...
  { id: "cafe-meetup", label: "Café meetup", category: "foodDrinksVenues", aliases: ["cafe meetup", "coffee meetup"], eventKeywords: ["cafe", "coffee", "meetup"] },
  ...
  { id: "dessert-meetup", label: "Dessert meetup", category: "foodDrinksVenues", aliases: ["dessert outing"], eventKeywords: ["dessert", "ice cream", "gelato", "meetup"] },
  { id: "bubble-tea-meetup", label: "Bubble tea meetup", category: "foodDrinksVenues", aliases: ["boba meetup"], eventKeywords: ["bubble tea", "boba", "meetup"] },
  { id: "restaurants", label: "Restaurants", category: "foodDrinksVenues", eventKeywords: ["restaurant", "food"] },
  { id: "casual-dining", label: "Casual dining", category: "foodDrinksVenues", aliases: ["casual dinner", "casual lunch"], eventKeywords: ["casual dining", "restaurant", "food"] },
  { id: "group-lunch-dinner", label: "Group lunch/dinner", category: "foodDrinksVenues", aliases: ["group lunch", "group dinner"], eventKeywords: ["lunch", "dinner", "food"] },
  { id: "food-court-meetup", label: "Food court meetup", category: "foodDrinksVenues", aliases: ["food court"], eventKeywords: ["food court", "food", "shopping centre"] },
  { id: "small-tables", label: "Small tables", category: "foodDrinksVenues", eventKeywords: ["small table", "food"] },
  { id: "quiet-cafes", label: "Quiet cafés", category: "foodDrinksVenues", aliases: ["quiet cafes"], eventKeywords: ["quiet cafe", "coffee", "cafe"] },
  ...
  { id: "shopping-centre-hangout", label: "Shopping centre hangout", category: "foodDrinksVenues", aliases: ["mall hangout", "shopping mall hangout"], eventKeywords: ["shopping centre", "mall", "food court"] },
  { id: "window-shopping", label: "Window shopping", category: "foodDrinksVenues", aliases: ["browsing shops"], eventKeywords: ["window shopping", "shopping centre", "browsing"] },
  ...
  { id: "aquariums", label: "Aquariums", category: "travelCulture", eventKeywords: ["aquarium", "aquariums", "animals"] },
  { id: "aquarium-visit", label: "Aquarium visit", category: "travelCulture", aliases: ["aquarium outing"], eventKeywords: ["aquarium", "visit", "animals"] },
