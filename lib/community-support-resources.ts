...
const demoPlaceholder = "Demo" as const;
...
export const communitySupportResourceCategories: CommunitySupportResourceCategory[] = [
  {
    ...
    badge: "Demo",
    boundaryNote: "Prototype placeholders only; not reviewed, personalised, or a substitute for qualified services.",
    resources: [
  ...
  },
  {
    ...
    badge: "Demo",
    boundaryNote: "Prototype placeholders only; local groups and opportunities are not reviewed yet.",
    resources: [
  ...
  },
  {
    ...
    badge: "Demo",
    boundaryNote: "Prototype placeholders only; volunteering and welfare links are not reviewed yet.",
    resources: [
